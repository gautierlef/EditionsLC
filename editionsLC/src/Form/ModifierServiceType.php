...
class ModifierServiceType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('nbDonnes', NumberType::class, array('label' => 'Nombre de livres donnés : ', 'attr' => array('placeholder' => "Saisir nombre de livres donnés", 'class' => 'form-control')))
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            'data_class' => ServicePresse::class,
        ]);
    }
}
