...
class ModifierBonType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('nbVendus', NumberType::class, array('label' => 'Nombre de livres vendus : ', 'attr' => array('placeholder' => "Saisir nombre de livres vendus", 'class' => 'form-control')))
